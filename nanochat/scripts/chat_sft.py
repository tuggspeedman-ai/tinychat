...
train_ds = TaskMixture([
    ...
    CustomJSON(filepath=identity_conversations_filepath), # 1.5K rows of synthetic identity conversations (epoch 1)
    CustomJSON(filepath=identity_conversations_filepath), # 1.5K rows (epoch 2)
    CustomJSON(filepath=identity_conversations_filepath), # 1.5K rows (epoch 3)
...
]) # 2.3K + 1.1K + 8K + 10K + 4.5K + 0.3K + 0.3K = 26.5K rows (identity ~17% of mix)
