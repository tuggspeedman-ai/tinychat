...
parser = argparse.ArgumentParser(description='TinyChat Web Server')
...
async def lifespan(app: FastAPI):
    ...
    print("Loading TinyChat models across GPUs...")
...
@app.get("/logo.svg")
async def logo():
    """Serve the TinyChat logo for favicon and header."""
...
if __name__ == "__main__":
    import uvicorn
    print(f"Starting TinyChat Web Server")
